...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.le_lenwingright.setGeometry(QRect(527, 214, 112, 28))
        ...
        self.le_crackfracture.setGeometry(QRect(383, 362, 113, 28))
        ...
        self.le_y.setGeometry(QRect(527, 129, 111, 28))
        ...
        self.param_y.setGeometry(QRect(527, 157, 111, 20))
